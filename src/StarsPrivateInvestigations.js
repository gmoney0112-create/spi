...
export default function StarsPrivateInvestigations() {
  ...
  const servicePages = {
    ...
    'extradition': {
      title: 'Extradition Services',
      tagline: 'Professional fugitive transport. Safe. Compliant. Reliable.',
      hero: 'Stars Private Investigations provides professional extradition and fugitive transport services for law enforcement agencies, bail bond companies, and government entities throughout Texas and across state lines.',
      intro: 'Extradition is a high-stakes operation that requires careful planning, legal compliance, and experienced personnel who understand how to transport individuals safely and lawfully. Our team brings active and retired law enforcement experience to every transport — ensuring every step follows applicable federal, state, and jurisdictional requirements. We handle the logistics, documentation, and coordination so your agency can focus on the case.',
      includes: [
        'Fugitive location and apprehension coordination',
        'Interstate and intrastate transport services',
        'Full compliance with extradition laws and jurisdictional requirements',
        'Secure transport vehicles and restraint protocols',
        'Coordination with arresting jurisdictions and receiving agencies',
        'Documentation for court and agency records',
        'Medical and emergency protocols during transport',
        '24/7 availability for time-sensitive transports',
      ],
      useCases: ['County sheriff and municipal police departments', 'Bail bond companies requiring fugitive recovery', 'State agencies with cross-jurisdictional warrants', 'District and county attorneys coordinating prisoner transfers', 'Federal agencies requiring contract transport support', 'Private legal counsel coordinating voluntary surrender transports'],
      why: 'Our leadership includes active law enforcement and military veterans who have handled complex prisoner transport and custody situations. We understand the legal, safety, and documentation requirements that make extradition services defensible in court and compliant with agency standards. We treat every transport with the seriousness it demands.',
    },
    'monitoring': {
      title: 'Personnel Monitoring',
      tagline: 'Accountability. Documentation. Peace of mind.',
      hero: 'Stars Private Investigations provides discreet personnel monitoring services for employers, attorneys, and businesses that need documented, objective information about employee conduct, compliance, and activity.',
      intro: 'Personnel monitoring is one of the most sensitive and legally nuanced areas of private security. Whether you suspect workers\' compensation fraud, unauthorized use of company resources, policy violations, or simply need documented evidence of field activity, our team conducts monitoring with legal precision, professional discretion, and defensible documentation practices. We operate within the bounds of Texas law at all times.',
      includes: [
        'Covert field surveillance of subjects',
        'Video and photographic documentation of activity',
        'GPS and vehicle monitoring (where legally authorized)',
        'Timestamped activity reports for legal and HR use',
        'Workers\' compensation and disability fraud investigations',
        'Vendor and contractor compliance monitoring',
        'Employee conduct and policy violation documentation',
        'Expert consultation on Texas employer monitoring laws',
      ],
      useCases: ['Employers investigating suspected workers\' compensation fraud', 'Companies with suspected employee theft or misconduct', 'Insurance companies investigating disability or injury claims', 'Attorneys requiring documented evidence for employment litigation', 'Businesses monitoring remote or field employees for compliance', 'Organizations conducting due diligence on contractors or vendors'],
      why: 'Personnel monitoring done wrong creates significant legal exposure for employers. Done right, it provides defensible, court-ready documentation that protects your business. Our team understands Texas employer law, admissibility standards, and chain-of-custody documentation — ensuring the evidence we gather can actually be used when you need it.',
    },
    'process': {
      title: 'Process Serving',
      tagline: 'Fast. Documented. Legally defensible.',
      hero: 'Stars Private Investigations provides professional process serving throughout San Antonio, South Texas, Eagle Pass, and surrounding areas — delivering legal documents accurately, promptly, and with complete documentation of service.',
      intro: 'Process serving is a critical link in the legal chain. Improperly served documents can delay or derail cases, expose attorneys to malpractice risk, and give opposing parties grounds to challenge proceedings. Our process servers are experienced, professional, and familiar with Texas Rules of Civil Procedure — ensuring every serve is completed correctly and documented in a form courts accept.',
      includes: [
        'Service of summons, subpoenas, petitions, and complaints',
        'Restraining orders and injunctions',
        'Family law documents (divorce, custody, protective orders)',
        'Civil and commercial litigation documents',
        'Affidavit of service with complete documentation',
        'Attempt logs for difficult-to-serve subjects',
        'Skip tracing for evasive or relocated subjects',
        'Rush and same-day service available',
      ],
      useCases: ['Family law attorneys serving divorce and custody documents', 'Civil litigation firms serving opposing parties', 'Debt collection attorneys serving debtors', 'Corporate counsel serving business litigation documents', 'Individuals filing pro se requiring professional service', 'Out-of-state attorneys needing local Texas process servers'],
      why: 'We serve difficult subjects. Skip tracing, stakeouts, and persistent professional follow-up are part of how we operate when a subject is avoiding service. Every serve we complete includes a detailed affidavit documenting time, date, location, description, and manner of service — prepared to withstand scrutiny in any Texas court.',
    },
    'training': {
      title: 'Security Training & Classes',
      tagline: 'Industry-standard certifications. Expert instructors. Practical skills.',
      hero: 'Stars Private Investigations offers professional security training and certification courses for individuals, security officers, law enforcement, and organizations throughout San Antonio and South Texas — taught by veterans and active law enforcement professionals.',
      intro: 'The difference between a trained security professional and an untrained one can be life or death. Our training programs are built around real-world scenarios, practical skill development, and the certifications Texas employers and licensing boards require. Whether you\'re entering the security field, renewing certifications, or upskilling your team, Stars delivers training that actually prepares you for what happens in the field.',
      includes: [
        'CPT Crisis Prevention Institute training',
        'CPR & First Aid certification',
        'Psychological handling & de-escalation',
        'MOAB (Management of Aggressive Behavior) training',
        'AXON and TASER operator training',
        'Level III & IV security officer training',
        'Firearms training & Concealed Carry License (LTC)',
        'Active shooter response training',
        'NRA Civilian and Law Enforcement (LEO) training',
        'Crash prevention instruction',
      ],
      useCases: ['Aspiring security officers seeking Texas DPS licensing', 'Security companies upskilling their officer teams', 'Businesses training in-house security or safety staff', 'Law enforcement seeking civilian-context certifications', 'Individuals pursuing Concealed Carry License (LTC)', 'Organizations requiring active shooter preparedness training'],
      why: 'Our instructors are not classroom-only trainers. They are veterans, active law enforcement, and experienced security professionals who have applied these skills under real conditions. Training from Stars means learning from people who\'ve been in the situations you might face — and who can teach you what the textbook leaves out.',
    },
  };
